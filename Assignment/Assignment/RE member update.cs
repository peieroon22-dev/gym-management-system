...
{
    public partial class RE_member_update : ReBaseForm
    {
        public RE_member_update()
        {
            InitializeComponent();
        }
        ...
        {
            txt_Email.Text = txt_Home.Text = txt_memberID.Text = txt_Name.Text = txt_phoneNumber.Text = "";
        }
