...
{
    public partial class Manager_training_session : BaseForm
    {
        public Manager_training_session()
        {
            InitializeComponent();
        }
        ...
        private void Manager_training_session_Load(object sender, EventArgs e)
        {
        ...
        {
            Manager_training_session_add manager_Training_Session_Add = new Manager_training_session_add();
            manager_Training_Session_Add.Show();
            this.Close();
        }

        private void btn_update_Click(object sender, EventArgs e)
        {
            Manager_training_session_update manager_Training_Session_Update = new Manager_training_session_update();
            manager_Training_Session_Update.Show();
            this.Close();
        }

        private void btn_delete_Click(object sender, EventArgs e)
        {
            Manager_training_session_delete manager_Training_Session_Delete = new Manager_training_session_delete();
            manager_Training_Session_Delete.Show();
            this.Close();
        }

        private void btn_report_Click(object sender, EventArgs e)
        {
            Manager_training_session_report manager_Training_Session_Report = new Manager_training_session_report();
            manager_Training_Session_Report.Show();
            this.Close();
        }
