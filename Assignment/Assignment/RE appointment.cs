...
{
    public partial class RE_appointment : ReBaseForm
    {
        public RE_appointment()
        {
            InitializeComponent();
        }
        ...
        private void RE_appointment_Load(object sender, EventArgs e)
        {
            LoadAppointmentData();
        }
        ...
        {
            RE_appointment_add rE_Appointment_Add = new RE_appointment_add();
            rE_Appointment_Add.Show();
            this.Close();
        }

        private void btn_update_Click(object sender, EventArgs e)
        {
            RE_appointment_update rE_Appointment_Update = new RE_appointment_update();
            rE_Appointment_Update.Show();
            this.Close();
        }

        private void btn_delete_Click(object sender, EventArgs e)
        {
            RE_appointment_delete rE_Appointment_Delete = new RE_appointment_delete();
            rE_Appointment_Delete.Show();
            this.Close();
        }
